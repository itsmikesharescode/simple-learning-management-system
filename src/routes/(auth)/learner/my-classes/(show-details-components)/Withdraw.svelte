...
{#if showWithdraw}
	<div class="fixed left-0 right-0 top-0 bottom-0 bg-[#00000050] p-2">
		<div class="min-h-[80dvh]  mx-auto md:max-w-xl flex items-center" in:scale>
			...
			<form method="POST" action="" enctype="multipart/form-data" use:enhance class="w-full">
...
<Button title="Click, to withdraw in this class." style="bg-red-500 px-2 py-[0.3rem] rounded-lg text-sm text-white font-bold" name="Withdraw" on:click={() => showWithdraw = true} />